...
exports.ComplexZmanimCalendar = void 0;
const luxon_1 = require("luxon");
const Utils_1 = require("./polyfills/Utils");
const ZmanimCalendar_1 = require("./ZmanimCalendar");
const JewishCalendar_1 = require("./hebrewcalendar/JewishCalendar");
/**
 ...
 */
class ComplexZmanimCalendar extends ZmanimCalendar_1.ZmanimCalendar {
    constructor() {
        super(...arguments);
        /**
  ...
  */
    ...
    getAlos72Zmanis() {
        ...
        if (shaahZmanis === Utils_1.Long_MIN_VALUE) {
            return null;
        }
    ...
    getMinchaGedolaGreaterThan30() {
        ...
        return luxon_1.DateTime.max(this.getMinchaGedola30Minutes(), this.getMinchaGedola());
    }
    /**
    ...
    getFixedLocalChatzos() {
        ...
        const rawOffsetHours = Utils_1.TimeZone.getRawOffset(geoLocation.getTimeZone()) / ComplexZmanimCalendar.HOUR_MILLIS;
    ...
    getSofZmanKidushLevanaBetweenMoldos(alos = null, tzais = null) {
        const jewishCalendar = new JewishCalendar_1.JewishCalendar(this.getDate());
  ...
  */
    ...
    getTchilasZmanKidushLevana3Days(alos = null, tzais = null) {
        const jewishCalendar = new JewishCalendar_1.JewishCalendar();
        ...
        if (zman === null && jewishCalendar.getJewishDayOfMonth() === 30) {
            jewishCalendar.forward(Utils_1.Calendar.MONTH, 1);
  ...
  */
   ...
   * <em>netz amiti</em> (sunrise)}.
    ...
    getMinchaGedolaBaalHatanyaGreaterThan30() {
        ...
        return luxon_1.DateTime.max(this.getMinchaGedola30Minutes(), this.getMinchaGedolaBaalHatanya());
    }
    /**
