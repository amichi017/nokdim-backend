...
exports.HebrewDateFormatter = void 0;
const JewishDate_1 = require("./JewishDate");
...
class HebrewDateFormatter {
    constructor() {
        ...
        this.transliteratedParshaMap = {
            [JewishCalendar_1.Parsha.NONE]: '',
            [JewishCalendar_1.Parsha.BERESHIS]: 'Bereshis',
            [JewishCalendar_1.Parsha.NOACH]: 'Noach',
            [JewishCalendar_1.Parsha.LECH_LECHA]: 'Lech Lecha',
            [JewishCalendar_1.Parsha.VAYERA]: 'Vayera',
            [JewishCalendar_1.Parsha.CHAYEI_SARA]: 'Chayei Sara',
            [JewishCalendar_1.Parsha.TOLDOS]: 'Toldos',
            [JewishCalendar_1.Parsha.VAYETZEI]: 'Vayetzei',
            [JewishCalendar_1.Parsha.VAYISHLACH]: 'Vayishlach',
            [JewishCalendar_1.Parsha.VAYESHEV]: 'Vayeshev',
            [JewishCalendar_1.Parsha.MIKETZ]: 'Miketz',
            [JewishCalendar_1.Parsha.VAYIGASH]: 'Vayigash',
            [JewishCalendar_1.Parsha.VAYECHI]: 'Vayechi',
            [JewishCalendar_1.Parsha.SHEMOS]: 'Shemos',
            [JewishCalendar_1.Parsha.VAERA]: 'Vaera',
            [JewishCalendar_1.Parsha.BO]: 'Bo',
            [JewishCalendar_1.Parsha.BESHALACH]: 'Beshalach',
            [JewishCalendar_1.Parsha.YISRO]: 'Yisro',
            [JewishCalendar_1.Parsha.MISHPATIM]: 'Mishpatim',
            [JewishCalendar_1.Parsha.TERUMAH]: 'Terumah',
            [JewishCalendar_1.Parsha.TETZAVEH]: 'Tetzaveh',
            [JewishCalendar_1.Parsha.KI_SISA]: 'Ki Sisa',
            [JewishCalendar_1.Parsha.VAYAKHEL]: 'Vayakhel',
            [JewishCalendar_1.Parsha.PEKUDEI]: 'Pekudei',
            [JewishCalendar_1.Parsha.VAYIKRA]: 'Vayikra',
            [JewishCalendar_1.Parsha.TZAV]: 'Tzav',
            [JewishCalendar_1.Parsha.SHMINI]: 'Shmini',
            [JewishCalendar_1.Parsha.TAZRIA]: 'Tazria',
            [JewishCalendar_1.Parsha.METZORA]: 'Metzora',
            [JewishCalendar_1.Parsha.ACHREI_MOS]: 'Achrei Mos',
            [JewishCalendar_1.Parsha.KEDOSHIM]: 'Kedoshim',
            [JewishCalendar_1.Parsha.EMOR]: 'Emor',
            [JewishCalendar_1.Parsha.BEHAR]: 'Behar',
            [JewishCalendar_1.Parsha.BECHUKOSAI]: 'Bechukosai',
            [JewishCalendar_1.Parsha.BAMIDBAR]: 'Bamidbar',
            [JewishCalendar_1.Parsha.NASSO]: 'Nasso',
            [JewishCalendar_1.Parsha.BEHAALOSCHA]: 'Beha\'aloscha',
            [JewishCalendar_1.Parsha.SHLACH]: 'Sh\'lach',
            [JewishCalendar_1.Parsha.KORACH]: 'Korach',
            [JewishCalendar_1.Parsha.CHUKAS]: 'Chukas',
            [JewishCalendar_1.Parsha.BALAK]: 'Balak',
            [JewishCalendar_1.Parsha.PINCHAS]: 'Pinchas',
            [JewishCalendar_1.Parsha.MATOS]: 'Matos',
            [JewishCalendar_1.Parsha.MASEI]: 'Masei',
            [JewishCalendar_1.Parsha.DEVARIM]: 'Devarim',
            [JewishCalendar_1.Parsha.VAESCHANAN]: 'Vaeschanan',
            [JewishCalendar_1.Parsha.EIKEV]: 'Eikev',
            [JewishCalendar_1.Parsha.REEH]: 'Re\'eh',
            [JewishCalendar_1.Parsha.SHOFTIM]: 'Shoftim',
            [JewishCalendar_1.Parsha.KI_SEITZEI]: 'Ki Seitzei',
            [JewishCalendar_1.Parsha.KI_SAVO]: 'Ki Savo',
            [JewishCalendar_1.Parsha.NITZAVIM]: 'Nitzavim',
            [JewishCalendar_1.Parsha.VAYEILECH]: 'Vayeilech',
            [JewishCalendar_1.Parsha.HAAZINU]: 'Ha\'Azinu',
            [JewishCalendar_1.Parsha.VZOS_HABERACHA]: 'Vezos Habracha',
            [JewishCalendar_1.Parsha.VAYAKHEL_PEKUDEI]: 'Vayakhel Pekudei',
            [JewishCalendar_1.Parsha.TAZRIA_METZORA]: 'Tazria Metzora',
            [JewishCalendar_1.Parsha.ACHREI_MOS_KEDOSHIM]: 'Achrei Mos Kedoshim',
            [JewishCalendar_1.Parsha.BEHAR_BECHUKOSAI]: 'Behar Bechukosai',
            [JewishCalendar_1.Parsha.CHUKAS_BALAK]: 'Chukas Balak',
            [JewishCalendar_1.Parsha.MATOS_MASEI]: 'Matos Masei',
            [JewishCalendar_1.Parsha.NITZAVIM_VAYEILECH]: 'Nitzavim Vayeilech',
            [JewishCalendar_1.Parsha.SHKALIM]: 'Shekalim',
            [JewishCalendar_1.Parsha.ZACHOR]: 'Zachor',
            [JewishCalendar_1.Parsha.PARA]: 'Parah',
            [JewishCalendar_1.Parsha.HACHODESH]: 'Hachodesh',
        };
        this.hebrewParshaMap = {
            [JewishCalendar_1.Parsha.NONE]: '',
            [JewishCalendar_1.Parsha.BERESHIS]: '\u05D1\u05E8\u05D0\u05E9\u05D9\u05EA',
            [JewishCalendar_1.Parsha.NOACH]: '\u05E0\u05D7',
            [JewishCalendar_1.Parsha.LECH_LECHA]: '\u05DC\u05DA \u05DC\u05DA',
            [JewishCalendar_1.Parsha.VAYERA]: '\u05D5\u05D9\u05E8\u05D0',
            [JewishCalendar_1.Parsha.CHAYEI_SARA]: '\u05D7\u05D9\u05D9 \u05E9\u05E8\u05D4',
            [JewishCalendar_1.Parsha.TOLDOS]: '\u05EA\u05D5\u05DC\u05D3\u05D5\u05EA',
            [JewishCalendar_1.Parsha.VAYETZEI]: '\u05D5\u05D9\u05E6\u05D0',
            [JewishCalendar_1.Parsha.VAYISHLACH]: '\u05D5\u05D9\u05E9\u05DC\u05D7',
            [JewishCalendar_1.Parsha.VAYESHEV]: '\u05D5\u05D9\u05E9\u05D1',
            [JewishCalendar_1.Parsha.MIKETZ]: '\u05DE\u05E7\u05E5',
            [JewishCalendar_1.Parsha.VAYIGASH]: '\u05D5\u05D9\u05D2\u05E9',
            [JewishCalendar_1.Parsha.VAYECHI]: '\u05D5\u05D9\u05D7\u05D9',
            [JewishCalendar_1.Parsha.SHEMOS]: '\u05E9\u05DE\u05D5\u05EA',
            [JewishCalendar_1.Parsha.VAERA]: '\u05D5\u05D0\u05E8\u05D0',
            [JewishCalendar_1.Parsha.BO]: '\u05D1\u05D0',
            [JewishCalendar_1.Parsha.BESHALACH]: '\u05D1\u05E9\u05DC\u05D7',
            [JewishCalendar_1.Parsha.YISRO]: '\u05D9\u05EA\u05E8\u05D5',
            [JewishCalendar_1.Parsha.MISHPATIM]: '\u05DE\u05E9\u05E4\u05D8\u05D9\u05DD',
            [JewishCalendar_1.Parsha.TERUMAH]: '\u05EA\u05E8\u05D5\u05DE\u05D4',
            [JewishCalendar_1.Parsha.TETZAVEH]: '\u05EA\u05E6\u05D5\u05D4',
            [JewishCalendar_1.Parsha.KI_SISA]: '\u05DB\u05D9 \u05EA\u05E9\u05D0',
            [JewishCalendar_1.Parsha.VAYAKHEL]: '\u05D5\u05D9\u05E7\u05D4\u05DC',
            [JewishCalendar_1.Parsha.PEKUDEI]: '\u05E4\u05E7\u05D5\u05D3\u05D9',
            [JewishCalendar_1.Parsha.VAYIKRA]: '\u05D5\u05D9\u05E7\u05E8\u05D0',
            [JewishCalendar_1.Parsha.TZAV]: '\u05E6\u05D5',
            [JewishCalendar_1.Parsha.SHMINI]: '\u05E9\u05DE\u05D9\u05E0\u05D9',
            [JewishCalendar_1.Parsha.TAZRIA]: '\u05EA\u05D6\u05E8\u05D9\u05E2',
            [JewishCalendar_1.Parsha.METZORA]: '\u05DE\u05E6\u05E8\u05E2',
            [JewishCalendar_1.Parsha.ACHREI_MOS]: '\u05D0\u05D7\u05E8\u05D9 \u05DE\u05D5\u05EA',
            [JewishCalendar_1.Parsha.KEDOSHIM]: '\u05E7\u05D3\u05D5\u05E9\u05D9\u05DD',
            [JewishCalendar_1.Parsha.EMOR]: '\u05D0\u05DE\u05D5\u05E8',
            [JewishCalendar_1.Parsha.BEHAR]: '\u05D1\u05D4\u05E8',
            [JewishCalendar_1.Parsha.BECHUKOSAI]: '\u05D1\u05D7\u05E7\u05EA\u05D9',
            [JewishCalendar_1.Parsha.BAMIDBAR]: '\u05D1\u05DE\u05D3\u05D1\u05E8',
            [JewishCalendar_1.Parsha.NASSO]: '\u05E0\u05E9\u05D0',
            [JewishCalendar_1.Parsha.BEHAALOSCHA]: '\u05D1\u05D4\u05E2\u05DC\u05EA\u05DA',
            [JewishCalendar_1.Parsha.SHLACH]: '\u05E9\u05DC\u05D7 \u05DC\u05DA',
            [JewishCalendar_1.Parsha.KORACH]: '\u05E7\u05E8\u05D7',
            [JewishCalendar_1.Parsha.CHUKAS]: '\u05D7\u05D5\u05E7\u05EA',
            [JewishCalendar_1.Parsha.BALAK]: '\u05D1\u05DC\u05E7',
            [JewishCalendar_1.Parsha.PINCHAS]: '\u05E4\u05D9\u05E0\u05D7\u05E1',
            [JewishCalendar_1.Parsha.MATOS]: '\u05DE\u05D8\u05D5\u05EA',
            [JewishCalendar_1.Parsha.MASEI]: '\u05DE\u05E1\u05E2\u05D9',
            [JewishCalendar_1.Parsha.DEVARIM]: '\u05D3\u05D1\u05E8\u05D9\u05DD',
            [JewishCalendar_1.Parsha.VAESCHANAN]: '\u05D5\u05D0\u05EA\u05D7\u05E0\u05DF',
            [JewishCalendar_1.Parsha.EIKEV]: '\u05E2\u05E7\u05D1',
            [JewishCalendar_1.Parsha.REEH]: '\u05E8\u05D0\u05D4',
            [JewishCalendar_1.Parsha.SHOFTIM]: '\u05E9\u05D5\u05E4\u05D8\u05D9\u05DD',
            [JewishCalendar_1.Parsha.KI_SEITZEI]: '\u05DB\u05D9 \u05EA\u05E6\u05D0',
            [JewishCalendar_1.Parsha.KI_SAVO]: '\u05DB\u05D9 \u05EA\u05D1\u05D5\u05D0',
            [JewishCalendar_1.Parsha.NITZAVIM]: '\u05E0\u05D9\u05E6\u05D1\u05D9\u05DD',
            [JewishCalendar_1.Parsha.VAYEILECH]: '\u05D5\u05D9\u05DC\u05DA',
            [JewishCalendar_1.Parsha.HAAZINU]: '\u05D4\u05D0\u05D6\u05D9\u05E0\u05D5',
            [JewishCalendar_1.Parsha.VZOS_HABERACHA]: '\u05D5\u05D6\u05D0\u05EA \u05D4\u05D1\u05E8\u05DB\u05D4 ',
            [JewishCalendar_1.Parsha.VAYAKHEL_PEKUDEI]: '\u05D5\u05D9\u05E7\u05D4\u05DC \u05E4\u05E7\u05D5\u05D3\u05D9',
            [JewishCalendar_1.Parsha.TAZRIA_METZORA]: '\u05EA\u05D6\u05E8\u05D9\u05E2 \u05DE\u05E6\u05E8\u05E2',
            [JewishCalendar_1.Parsha.ACHREI_MOS_KEDOSHIM]: '\u05D0\u05D7\u05E8\u05D9 \u05DE\u05D5\u05EA \u05E7\u05D3\u05D5\u05E9\u05D9\u05DD',
            [JewishCalendar_1.Parsha.BEHAR_BECHUKOSAI]: '\u05D1\u05D4\u05E8 \u05D1\u05D7\u05E7\u05EA\u05D9',
            [JewishCalendar_1.Parsha.CHUKAS_BALAK]: '\u05D7\u05D5\u05E7\u05EA \u05D1\u05DC\u05E7',
            [JewishCalendar_1.Parsha.MATOS_MASEI]: '\u05DE\u05D8\u05D5\u05EA \u05DE\u05E1\u05E2\u05D9',
            [JewishCalendar_1.Parsha.NITZAVIM_VAYEILECH]: '\u05E0\u05D9\u05E6\u05D1\u05D9\u05DD \u05D5\u05D9\u05DC\u05DA',
            [JewishCalendar_1.Parsha.SHKALIM]: '\u05E9\u05E7\u05DC\u05D9\u05DD',
            [JewishCalendar_1.Parsha.ZACHOR]: '\u05D6\u05DB\u05D5\u05E8',
            [JewishCalendar_1.Parsha.PARA]: '\u05E4\u05E8\u05D4',
            [JewishCalendar_1.Parsha.HACHODESH]: '\u05D4\u05D7\u05D3\u05E9',
        };
    ...
    formatYomTov(jewishCalendar) {
        ...
        if (index === JewishCalendar_1.JewishCalendar.CHANUKAH) {
    ...
    formatRoshChodesh(jewishCalendar) {
        ...
        if (jewishCalendar.getJewishDayOfMonth() === 30) {
            if (month < JewishCalendar_1.JewishCalendar.ADAR || (month === JewishCalendar_1.JewishCalendar.ADAR && jewishCalendar.isJewishLeapYear())) {
                month++;
            }
            else { // roll to Nissan
                month = JewishCalendar_1.JewishCalendar.NISSAN;
            }
        }
        ...
        formattedRoshChodesh = this.hebrewFormat ? HebrewDateFormatter.hebrewHolidays[JewishCalendar_1.JewishCalendar.ROSH_CHODESH]
            : this.transliteratedHolidays[JewishCalendar_1.JewishCalendar.ROSH_CHODESH];
    ...
    formatMonth(jewishDate) {
        ...
        if (this.isHebrewFormat()) {
            if (jewishDate.isJewishLeapYear() && month === JewishDate_1.JewishDate.ADAR) {
                return this.hebrewMonths[13] + (this.useGershGershayim ? HebrewDateFormatter.GERESH : ''); // return Adar I, not Adar in a leap year
            }
            else if (jewishDate.isJewishLeapYear() && month === JewishDate_1.JewishDate.ADAR_II) {
    ...
    getFormattedKviah(jewishYear) {
        const jewishDate = new JewishDate_1.JewishDate(jewishYear, JewishDate_1.JewishDate.TISHREI, 1); // set date to Rosh Hashana
        ...
        returnValue += (kviah === JewishDate_1.JewishDate.CHASERIM ? '\u05D7' : kviah === JewishDate_1.JewishDate.SHELAIMIM ? '\u05E9' : '\u05DB');
        jewishDate.setJewishDate(jewishYear, JewishDate_1.JewishDate.NISSAN, 15); // set to Pesach of the given year
    ...
    formatHebrewNumber(num) {
        if (num !== Math.trunc(num))
            throw new errors_1.IllegalArgumentException('number must be an integer.');
        if (num < 0) {
            throw new errors_1.IllegalArgumentException('negative numbers can\'t be formatted');
        }
        else if (num > 9999) {
            throw new errors_1.IllegalArgumentException('numbers > 9999 can\'t be formatted');
        }
        const ALAFIM = '\u05D0\u05DC\u05E4\u05D9\u05DD';
        const EFES = '\u05D0\u05E4\u05E1';
