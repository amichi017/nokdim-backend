...
class YomiCalculator {
    ...
    static getDafYomiBavli(calendar) {
        ...
        if (date < YomiCalculator.dafYomiStartDate) {
            ...
            throw new errors_1.IllegalArgumentException(`${calendar} is prior to organized Daf Yomi Bavli cycles that started on ${YomiCalculator.dafYomiStartDate}`);
        }
        ...
        for (const blattInMasechta of blattPerMasechta) {
            ...
            if (dafNo < total) {
                ...
                dafYomi = new Daf_1.Daf(masechta, blatt);
                break;
            }
        }
        return dafYomi;
...
YomiCalculator.dafYomiStartDate = luxon_1.DateTime.fromObject({
    year: 1923,
    month: Utils_1.Calendar.SEPTEMBER + 1,
    day: 11,
});
YomiCalculator.dafYomiJulianStartDay = YomiCalculator.getJulianDay(YomiCalculator.dafYomiStartDate);
YomiCalculator.shekalimChangeDate = luxon_1.DateTime.fromObject({ year: 1975, month: Utils_1.Calendar.JUNE + 1, day: 24 });
