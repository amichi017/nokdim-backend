...
exports.JewishCalendar = exports.Parsha = void 0;
...
const { MONDAY, TUESDAY, THURSDAY, FRIDAY, SATURDAY } = Utils_1.Calendar;
/**
...
})(Parsha = exports.Parsha || (exports.Parsha = {}));
/**
 ...
 */
class JewishCalendar extends JewishDate_1.JewishDate {
    ...
    getMoladAsDate() {
        ...
        const geo = new GeoLocation_1.GeoLocation(locationName, latitude, longitude, yerushalayimStandardTZ);
    ...
    getDafYomiBavli() {
        ...
        throw new errors_1.UnsupportedError('This method is not supported, due to a circular dependency. Use `YomiCalculator.getDafYomiBavli(jewishCalendar)` instead');
    }
    /**
    ...
    getDafYomiYerushalmi() {
        ...
        throw new errors_1.UnsupportedError('This method is not supported, due to a circular dependency. Use `YerushalmiYomiCalculator.getDafYomiYerushalmi(jewishCalendar)` instead');
    }
    /**
