...
class NOAACalculator extends AstronomicalCalculator_1.AstronomicalCalculator {
    ...
    static getObliquityCorrection(julianCenturies) {
        ...
        const omega = 125.04 - 1934.136 * julianCenturies;
        return obliquityOfEcliptic + 0.00256 * Math.cos(Utils_1.MathUtils.degreesToRadians(omega)); // in degrees
    }
    /**
    ...
    static getEquationOfTime(julianCenturies) {
        ...
        return Utils_1.MathUtils.radiansToDegrees(equationOfTime) * 4; // in minutes of time
    }
    /**
    ...
    static getSunHourAngleAtSunrise(lat, solarDec, zenith) {
        const latRad = Utils_1.MathUtils.degreesToRadians(lat);
        const sdRad = Utils_1.MathUtils.degreesToRadians(solarDec);
        return (Math.acos(Math.cos(Utils_1.MathUtils.degreesToRadians(zenith)) / (Math.cos(latRad) * Math.cos(sdRad))
    ...
    static getSunHourAngleAtSunset(lat, solarDec, zenith) {
        const latRad = Utils_1.MathUtils.degreesToRadians(lat);
        const sdRad = Utils_1.MathUtils.degreesToRadians(solarDec);
        const hourAngle = (Math.acos(Math.cos(Utils_1.MathUtils.degreesToRadians(zenith)) / (Math.cos(latRad) * Math.cos(sdRad))
    ...
    static getSolarElevation(date, lat, lon) {
        ...
        const hourAngleRad = Utils_1.MathUtils.degreesToRadians(lon - longitude);
