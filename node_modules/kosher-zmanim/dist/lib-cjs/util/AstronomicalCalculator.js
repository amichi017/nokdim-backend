...
exports.AstronomicalCalculator = void 0;
...
class AstronomicalCalculator {
    ...
    getElevationAdjustment(elevation) {
        ...
        const elevationAdjustment = Utils_1.MathUtils.radiansToDegrees(Math.acos(this.earthRadius / (this.earthRadius + (elevation / 1000))));
