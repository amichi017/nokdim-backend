...
exports.SunTimesCalculator = void 0;
 ...
 * @version 1.1
 */
class SunTimesCalculator extends AstronomicalCalculator_1.AstronomicalCalculator {
    /**
    ...
    static sinDeg(deg) {
        ...
        return Math.sin(Utils_1.MathUtils.degreesToRadians(deg));
    }
    /**
    ...
    static acosDeg(x) {
        ...
        return Utils_1.MathUtils.radiansToDegrees(Math.acos(x));
    }
    /**
    ...
    static asinDeg(x) {
        ...
        return Utils_1.MathUtils.radiansToDegrees(Math.asin(x));
    }
    /**
    ...
    static tanDeg(deg) {
        ...
        return Math.tan(Utils_1.MathUtils.degreesToRadians(deg));
    }
    /**
    ...
    static cosDeg(deg) {
        ...
        return Math.cos(Utils_1.MathUtils.degreesToRadians(deg));
    }
    /**
